...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public static final int PIC_PHOTO_REQUEST = 2;
    public static final int PIC_VIDEO_REQUEST = 3;
                ...
                public void onClick(DialogInterface dialog, int which) {
                    switch (which){
                        ...
                        case 2://choose picture
                            ...
                            startActivityForResult(choosePhotoIntent,PIC_PHOTO_REQUEST);
                            break;
                        case 3:
                            Intent chooseVideoIntent = new Intent(Intent.ACTION_GET_CONTENT);
                            chooseVideoIntent.setType("video/*");
                            Toast.makeText(MainActivity.this,getString(R.string.video_file_size_warning),Toast.LENGTH_LONG).show();
                            startActivityForResult(chooseVideoIntent, PIC_VIDEO_REQUEST);
                            break;
                    }
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK){
            if(requestCode == PIC_PHOTO_REQUEST || requestCode == PIC_VIDEO_REQUEST){
                if(data==null){
                ...
                Log.i(TAG,"Media URI: "+mMediaUri);//content uri provided by content provider gallery
                if(requestCode== PIC_VIDEO_REQUEST){
                    ...
                    try {
                        ...
                        try {
                            ...
                            //not required to do anything as closing stream
                        }
